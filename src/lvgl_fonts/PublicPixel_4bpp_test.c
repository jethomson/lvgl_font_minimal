 ...
 * Size: 16 px
 * Bpp: 4
 * Opts: --bpp 4 --size 16 --no-compress --font PublicPixel-E447g.ttf --symbols abcABC0123 --format lvgl -o PublicPixel_4bpp_test.c
 ******************************************************************************/
...
#ifndef PUBLICPIXEL_4BPP_TEST
#define PUBLICPIXEL_4BPP_TEST 1
#endif

#if PUBLICPIXEL_4BPP_TEST
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 98, .adv_w = 256, .box_w = 12, .box_h = 14, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 182, .adv_w = 256, .box_w = 14, .box_h = 14, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 280, .adv_w = 256, .box_w = 14, .box_h = 14, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 378, .adv_w = 256, .box_w = 14, .box_h = 14, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 476, .adv_w = 256, .box_w = 14, .box_h = 14, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 574, .adv_w = 256, .box_w = 14, .box_h = 14, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 672, .adv_w = 256, .box_w = 14, .box_h = 10, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 742, .adv_w = 256, .box_w = 14, .box_h = 14, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 840, .adv_w = 256, .box_w = 14, .box_h = 10, .ofs_x = 0, .ofs_y = 0}
};
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t PublicPixel_4bpp_test = {
#else
lv_font_t PublicPixel_4bpp_test = {
#endif
...
#endif /*#if PUBLICPIXEL_4BPP_TEST*/
